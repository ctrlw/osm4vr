...
AFRAME.registerComponent('log-position', {
  ...
  tick: function () {
    ...
    // vertical movement (positive goes down) 
    var lvd = this.ly - lh.y;
    var rvd = this.ry - rh.y;
    var vd = (lvd + rvd) / 2;
    // horizontal movement
    ...
    var armWidth = this.leftHand.distanceTo(this.rightHand);
    let areBothHandsMovingDown = lvd > 0 && rvd > 0;
